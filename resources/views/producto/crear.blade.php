    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" wire:click="cerrar_modal('modal_producto')">
                    Cancelar
                </button>
                ...
                @if ($tipo == 2)
                    <button type="button" wire:click="grabar_edicion_producto" wire:loading.attr="disabled" wire:target="grabar_edicion_producto" class="btn btn-success btn-sm">
                        <span wire:loading.remove wire:target="grabar_edicion_producto">
                            Editar
                        </span>

                        <span wire:loading wire:target="grabar_edicion_producto">
                            <i class="fas fa-spinner fa-spin"></i>
                            Guardando...
                        </span>
                    </button>
